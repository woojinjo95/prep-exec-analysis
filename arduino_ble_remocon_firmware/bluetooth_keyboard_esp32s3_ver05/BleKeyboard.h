...
// const MediaKeyReport KEY_MEDIA_LOCAL_MACHINE_BROWSER = {0, 1, 0, 0}; // Opens "My Computer" on Windows
...
// const MediaKeyReport KEY_MEDIA_CONSUMER_CONTROL_CONFIGURATION = {0, 64, 0, 0}; // Media Selection
