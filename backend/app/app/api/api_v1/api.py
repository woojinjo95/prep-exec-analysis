from app.api.api_v1.endpoints import remocon, scenario, hardware_configuration, block, file, client, analysis_config, trace, shell, utility, analysis_result
...
api_router.include_router(block.router_detail, prefix="/scenario/blocks", tags=["scenario"])
api_router.include_router(block.block_group_router, prefix="/scenario/block_group", tags=["scenario"])
