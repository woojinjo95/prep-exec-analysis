from app.api.api_v1.endpoints import item, remocon, scenario, hardware_configuration, block, file, client, analysis_config, log_trace
...
api_router.include_router(log_trace.router, prefix="/log_trace", tags=["log_trace"])
