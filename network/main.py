...
def command_parser(command: dict, packet_capture_stop_event: Event):
    ...
    publish command '{"msg": "network_emulation", "data": {"action": "create", "packet_block": {"ip": "239.192.41.2"}}}'
    publish command '{"msg": "network_emulation", "data": {"action": "create", "packet_delay": 20}}'
    '''
