...
class MEDIAKeyCodes:
    ...
    KEY_MEDIA_NUM_1 = 0x1E
    KEY_MEDIA_NUM_2 = 0x1F
    KEY_MEDIA_NUM_3 = 0x20
    KEY_MEDIA_NUM_4 = 0x21
    KEY_MEDIA_NUM_5 = 0x22
    KEY_MEDIA_NUM_6 = 0x23
    KEY_MEDIA_NUM_7 = 0x24
    KEY_MEDIA_NUM_8 = 0x25
    KEY_MEDIA_NUM_9 = 0x26
    KEY_MEDIA_NUM_0 = 0x27
...
class Commands:
    ...
    stop = "S"
    write_key_code = "w"
    write_media_key_code = "W"
    press_key_code = "p"
    press_media_key_code = "P"
    release_key_code = "t"
    release_media_key_code = "T"
    release_all = "x"
    disconnect = "D"
    write_string = "o"
